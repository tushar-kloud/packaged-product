...
const MachineLearningCourses = () => {
  ...
  const mlCourse = labsData?.filter((course) => course.course === "ML") || [];
  dispatch({ type: LAB_SESSION_DETAILS_RESET });

  useEffect(() => {
    if (labsData == null || !labsData || labsData.length == 0)
      dispatch(getLabList());
      ...
      >
        ...
        <Box sx={{ my: 3 }}>
          ...
          <Typography variant="body1">
            Our Machine Learning course provides in-depth training on
            algorithms, data processing, and model development. You&apos;ll
            learn to create predictive models, automate decision-making, and
            work with real-world datasets. Whether you&apos;re a beginner or
            experienced, this course equips you with the skills needed to excel

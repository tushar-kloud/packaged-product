...
export default function FAQ() {
  ...
  // Function to handle accordion panel state change
  ...
  return (
    ...
    >
      ...
      <Box sx={{ width: "100%" }}>
        {/* Accordion panels for each FAQ item */}
        <Accordion
        ...
        >
          ...
          <AccordionDetails>
            ...
            >
              ...
              or calling our toll-free number. We&rsquo;re here to assist you promptly.
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              Absolutely! We offer a hassle-free return policy. If you&rsquo;re not
        ...
        >
          ...
          <AccordionDetails>
            ...
            >
              ...
              satisfaction and continually strive to exceed expectations in every
              aspect.
            </Typography>
          </AccordionDetails>
        </Accordion>
